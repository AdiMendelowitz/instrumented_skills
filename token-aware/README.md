...
- `tools/cost.py` — cost, breakeven, compare, estimate, plus `log`/`verify`/`render`/`cpd`
  subcommands. Pure functions, no network calls, refuses to compute anything against an
  expired rate table.
