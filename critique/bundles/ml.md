...
Lens definitions for ML, modelling, and analytics documents. Loaded when P2 signature-matches "ML, model, or analytics doc".
...
Standing checks: a reported metric with no stated dataset, split, or sample size; a comparison table where the baseline was measured under different conditions than the proposed method; a chart whose axes or normalisation aren't stated.
...
pre-mortem extends to: the most likely way this result fails to replicate or fails to generalise past the reported setting.
